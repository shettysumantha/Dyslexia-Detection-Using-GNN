...
C_features_labels = [extract_features_and_labels(G, 0) for G in C_graphs]
D_features_labels = [extract_features_and_labels(G, 1) for G in D_graphs]



# Concatenate features and labels for all graphs
all_features = np.concatenate([features.numpy() for features, _ in C_features_labels] + [features.numpy() for features, _ in D_features_labels], axis=0)
...
# Plot accuracy and loss in one graph
